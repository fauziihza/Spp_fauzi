  ...
  if (isset($_GET['id'])) {
    ...
    $data = mysqli_fetch_assoc($result);
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='form_pembayaran.php';</script>";
       }
  } else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id.');window.location='form_pembayaran.php';</script>";
...
<html lang="en">
  ...
  <body>
      ...
      <section class="base">
           ...
           <input name="id_pembayaran" value="<?php echo $data['id_pembayaran']; ?>"  hidden />
              <div class="form-group">
    <label for="text">id_petugas</label>
    <input type="text" name="id_petugas" class="form-control" value="<?php echo $data['id_petugas']; ?>" id="id_petugas">
  </div>
  <div class="form-group">
    <label for="text">nisn</label>
    <input type="text" class="form-control" name="nisn"
    value="<?php echo $data['nisn']; ?>" required="" id="nisn"> 
  </div> 
    <div class="form-group">
    <label for="text">Tgl_bayar</label>
    <input type="text" class="form-control" name="Tgl_bayar"
    value="<?php echo $data['Tgl_bayar']; ?>" required="" id="Tgl_bayar"> 
  </div> 
  <div class="form-group">
    <label for="text">Bulan_dibayar</label>
    <input type="text" class="form-control" name="Bulan_dibayar"
    value="<?php echo $data['Bulan_dibayar']; ?>" required="" id="Bulan_dibayar"> 
  </div> 
  <div class="form-group">
    <label for="text">tahun_dibayar</label>
    <input type="text" class="form-control" name="tahun_dibayar"
    value="<?php echo $data['tahun_dibayar']; ?>" required="" id="tahun_dibayar"> 
  </div> 
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    value="<?php echo $data['jumlah_bayar']; ?>" required="" id="jumlah_bayar"> 
  </div>
  <div class="form-group">
    <label for="text">ket</label>
    <input type="text" class="form-control" name="ket"
    value="<?php echo $data['ket']; ?>" required="" id="ket"> 
  </div>
