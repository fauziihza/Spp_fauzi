...
<html lang="en">
  ...
  <body>
        ...
        <h2 class="text-center">Edit spp</h2>
    ...
    <input type="text" name="id_spp" class="form-control" value="<?php echo $data['id_spp']; ?>" id="id_spp">
  </div>
  <div class="form-group">
    <label for="text">kompetensi_keahlian</label>
    <input type="text" class="form-control" name="kompetensi_keahlian"
    value="<?php echo $data['kompetensi_keahlian']; ?>" required="" id="kompetensi_keahlian"> 
  </div> 
    <div class="form-group">
    <label for="text">nominal</label>
    <input type="text" class="form-control" name="nominal"
    value="<?php echo $data['nominal']; ?>" required="" id="nominal"> 
    </div>
