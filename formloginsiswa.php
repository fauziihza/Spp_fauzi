<html lang="en">
    ...
    <div class="container p-2 mb-2 text-white rounded d-flex justify-content-center"style="margin-top :50px">
                <form style="width: 400px" action="cekloginsiswa.php" method="Post"> 
                <h1>LOGIN</h1>
    ...
    <input type="nis" name="nis" class="form-control" id="exampleInputPassword1">
    </div>
    </div>
    ...
    <button type="submit" class="btn btn-primary" href="formhomesiswa.php">Submit</button>
    <a class="btn btn-primary" href="formlogin.php" role="button">masuk sebagai admin/petugas</a>
    </form>
    </div>
